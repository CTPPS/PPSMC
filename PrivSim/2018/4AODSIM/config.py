...
# with command line options: --python_filename PPS-RunIIAutumn18DRPremix-00001_2_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:PPS-RunIIAutumn18DRPremix-00001.root --conditions 102X_upgrade2018_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --procModifiers premix_stage2 --filein file:PPS-RunIIAutumn18DRPremix-00001_0.root --era Run2_2018 --runUnscheduled --no_exec --mc -n 1313
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--python_filename nevts:1313'),

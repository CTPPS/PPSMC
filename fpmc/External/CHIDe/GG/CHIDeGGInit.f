...
C   =============================================================================  C
      subroutine CHIDeGGinit(s_,Etmin_,s2_,x_,xp_,iglu_,
...
C     Chose of dgdtab as a function of iglu
       if(iglu.EQ.1)then
        open(unit=99,file='External/CHIDe/Data/dgdtab1.d',status="old")
       elseif(iglu.EQ.2)then
        open(unit=99,file='External/CHIDe/Data/dgdtab2.d',status="old")
       elseif(iglu.EQ.3)then
        open(unit=99,file='External/CHIDe/Data/dgdtab3.d',status="old")
       elseif(iglu.EQ.4)then
        open(unit=99,file='External/CHIDe/Data/dgdtab4.d',status="old")
       endif
C     Open sudatab 
       open(unit=98,file='External/CHIDe/Data/ggsudatab.d',status="old")

...
scramv1 b
cmsRun xcfginput
mkdir -p /eos/cms/store/group/phys_pps/MC/requests_2017mcv2/private/AAZZ_bSM/AODSIM/xjob/
rsync -avPz xoutput /eos/cms/store/group/phys_pps/MC/requests_2017mcv2/private/AAZZ_bSM/AODSIM/xjob/xoutput
rm -rf xoutput
EndOfTestFile
chmod +x local.sh

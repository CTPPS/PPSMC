...
# with command line options: step1 --filein dbs:/GGToZZ_bSM-A0Z-1e-5_PtL-15_13TeV-fpmc-herwig6/RunIIFall17GS-93X_mc2017_realistic_v3-v2/GEN-SIM --fileout file:PPS-RunIIFall17DRPremix-00008_step1.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-MCv2_correctPU_94X_mc2017_realistic_v9-v1/GEN-SIM-DIGI-RAW --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 94X_mc2017_realistic_v11 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:2e34v40 --nThreads 8 --datamix PreMix --era Run2_2017 --python_filename PPS-RunIIFall17DRPremix-00008_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 17
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step1 nevts:17'),

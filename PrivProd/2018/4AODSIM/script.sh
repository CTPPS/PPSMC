...
scramv1 b
cmsRun xcfginput
mkdir /eos/cms/store/group/phys_pps/MC/requests_2018/private/AAZZ_bSM/AODSIM/xjob/
rsync -avPz xoutput /eos/cms/store/group/phys_pps/MC/requests_2018/private/AAZZ_bSM/AODSIM/xjob/xoutput
rm -rf xoutput
EndOfTestFile
chmod +x local.sh
